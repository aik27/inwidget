...
* authLogin - логин от любого аккаунта для авторизации. Поле НЕ является обязательным. 
* authPassword - пароль от любого аккаунта для авторизации. Поле НЕ является обязательным.

Виджет может работать без авторизации и access_token. Но для пагинации и альтернативных способов получения данных она необходима. 
...
Данные авторизации не передаются третьим лицам, в том числе автору виджета.

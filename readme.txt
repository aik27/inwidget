...
[*] ERROR #403 - аккаунт пользователя в Instagram не содержит фотографий. Ошибка говорит о том, что аккаунт пользователя найден, но не содержит фотографий.

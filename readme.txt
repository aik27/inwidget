...
* authLogin - логин от любого аккаунта для авторизации. Необязательное поле. 
* authPassword - пароль от любого аккаунта для авторизации. Необязательное поле.

Виджет может работать без авторизации. Но для пагинации и альтернативных способов получения данных она необходима. 
Если вам нужно выводить в виджет более 12 фотографий или нужна дополнительная надёжность заполните поля выше. 
Советую завести для этого отдельный аккаунт с отключенной двухшаговой аутентификацией.
...
* Добавлена авторизация в Instagram по логину и паролю. Авторизация необходима для пагинации и альтернативных способов получения данных.

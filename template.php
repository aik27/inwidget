...
if (!$inWidget) die('inWidget object is not initialized.');
...
<head>
    <title>inWidget - show pictures from instagram.com on your site! PHP widget.</title>
...
<div class='widget'>
    <a href="http://instagram.com/<php echo $inWidget->data->username; ?>" target="_blank" class="title">
        ...
        <div class="text"><php echo $inWidget->config['title']; ?></div>
        <div class="clear">&nbsp;</div>
    </a>
        ...
        <table class="profile">
            <tr>
                <td rowspan="2" class="avatar">
                    <a href="http://instagram.com/<php echo $inWidget->data->username; ?>" target="_blank"><img
                            src="<php echo $inWidget->data->avatar; ?>"></a>
                </td>
                <td class="value">
                    <php echo $inWidget->data->posts; ?>
                    <span>posts</span>
                </td>
                <td class="value">
                    <php echo $inWidget->data->followers; ?>
                    <span>followers</span>
                </td>
                <td class="value" style="border-right:none !important;">
                    <php echo $inWidget->data->following; ?>
                    <span>following</span>
                </td>
            </tr>
            <tr>
                <td colspan="3" style="border-right:none !important;">
                    <a href="http://instagram.com/<php echo $inWidget->data->username; ?>" class="follow" target="_blank">View
                        &#9658;</a>
                </td>
            </tr>
        </table>
...
<div class='copy'>
    &copy; <a href='http://inwidget.ru' target='_blank' title='Free Instagram widgets for your site!'>inwidget.ru</a>
</div>
</body>
</html>
<!-- 
	inWidget - show pictures from instagram.com on your site! PHP widget.
	http://inwidget.ru

        ...
        <table class="profile">
            <tr>
                <td rowspan="2" class="avatar">
                    <a href="http://instagram.com/<?=$inWidget->data->username?>" target="_blank"><img
                            src="<?=$inWidget->data->avatar?>"></a>
                </td>
                <td class="value">
                    <?=$inWidget->data->posts?>
                    <span>posts</span>
            ...
            <tr>
                <td colspan="3" style="border-right:none !important;">
                    <a href="http://instagram.com/<?=$inWidget->data->username?>" class="follow" target="_blank">View
                        &#9658;</a>
                </td>
            </tr>
        </table>
    ...
    <?php if (!empty($inWidget->data->images)) :
        ...
        <div id="widgetData" class="data">
            ...
            foreach ($inWidget->data->images as $key => $item) :
                ...
                <a href="<?=$item->link?>" class="image" target="_blank"><img src="<?=$thumbnail?>"/></a>
            <?php
            endforeach;
            ?>
            <div class="clear">&nbsp;</div>
